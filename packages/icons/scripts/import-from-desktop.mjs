...
const legacyMetadata = {
  ...
  "bell": { "title": "Bell", "titleZh": "通知", "categories": ["communication"], "tags": ["bell", "notification", "alert", "提醒", "通知"], "aliases": ["notification"], "motion": { "semantic": ["ring"], "transitions": [] } },
  ...
  "heart": { "title": "Heart", "titleZh": "喜欢", "categories": ["status"], "tags": ["heart", "like", "favorite", "喜欢", "收藏"], "aliases": ["like", "favorite"], "motion": { "semantic": ["beat"], "transitions": [] } },
  ...
  "refresh": { "title": "Refresh", "titleZh": "刷新", "categories": ["actions"], "tags": ["refresh", "reload", "sync", "刷新", "同步"], "aliases": ["reload", "sync"], "motion": { "semantic": ["rotate"], "transitions": [] } },
