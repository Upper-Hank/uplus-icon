...
import { animateIcon, type IconMotionName, type MotionControls, type MotionOptions } from './index.js'
...
function MotionIcon<Name extends IconName>(
  ...
  }, [autoplay, direction, duration, easing, loop, motion, name, onMotionReady, reducedMotion, trigger])
